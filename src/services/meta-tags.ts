// Dynamic Meta Tags Service for World Trade
...
const BASE_URL = 'https://worldtrade.app';
const DEFAULT_IMAGE = 'https://worldtrade.app/favico/og-image.png';
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | World Trade`;
...
export function resetMetaTags(): void {
  const defaultTitle = 'World Trade - Global Situation with AI Insights';
...
function generateDescription(
  ...
  return `World Trade ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
