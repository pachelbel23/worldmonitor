...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: 'Cyber Incidents', url: rss('https://news.google.com/rss/search?q=cyber+attack+OR+data+breach+OR+ransomware+OR+hacking+when:3d&hl=en-US&gl=US&ceid=US:en'), zhUrl: rss('https://news.google.com/rss/search?q=cyber+attack+OR+data+breach+OR+ransomware+OR+hacking+when:3d&hl=zh-TW&gl=TW&ceid=TW:zh-Hant') },
  ],
