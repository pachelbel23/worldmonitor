...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const storedVariant = localStorage.getItem('worldtrade-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      localStorage.setItem('worldtrade-variant', currentVariant);
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'worldtrade-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'worldtrade-tech-insights-top-v1';
      ...
      <div class="header">
        <div class="header-left">
          <div class="variant-switcher">
            <a href="${SITE_VARIANT === 'tech' ? 'https://worldtrade.app' : '#'}"
            ...
            <a href="${SITE_VARIANT === 'tech' ? '#' : 'https://tech.worldtrade.app'}"
               class="variant-option ${SITE_VARIANT === 'tech' ? 'active' : ''}"
               data-variant="tech"
          ...
          <a href="https://github.com/koala73/worldtrade" target="_blank" rel="noopener" class="github-link" title="${t('View on GitHub')}">
